...
/**
 * Vendored from @radix-ui/react-alert-dialog@1.1.15.
 * Upstream AlertDialogContent calls preventDefault() on outside pointer/focus events,
 * which blocks closing on overlay click. Those handlers are omitted so backdrop dismiss works.
 * @see https://github.com/radix-ui/primitives/blob/main/packages/react/alert-dialog/src/alert-dialog.tsx
 */
...
For more information, see https://radix-ui.com/primitives/docs/components/alert-dialog`
  ...
  React.useEffect(() => {
    ...
    const hasDescription = document.getElementById(describedBy)
